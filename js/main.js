...
function searchChange (){
  ...
  this.parentElement.style.boxShadow = "0 0 5px 1px rgb(0,0,0,0.1), 0 0 0 1px #0bdabe inset";
...
nextBtnSub_pofo.addEventListener('click',()=>{
  console.log(currentIdx);
  currentIdxSub_pofo++;
  slideBoxSub_pofo.style.left = -(currentIdxSub_pofo*slideWidthSub_pofo)+'px';
